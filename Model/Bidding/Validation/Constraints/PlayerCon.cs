...
/// <summary>Immutable set of constraints known about a single player at a given point of the auction.</summary>
public sealed class PlayerCon {
    ...
    public static PlayerCon CreateInitial(int minPc, int maxPc, int minCards, int maxCards) {
        ...
        var anyLength = new NumberRange(minCards, maxCards);

        return new PlayerCon(anyPc, anyLength, anyLength, anyLength, anyLength);
    }
