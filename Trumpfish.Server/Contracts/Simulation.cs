...
/// <summary>Batch of deals to simulate with the given bidding system.</summary>
public record SimulationRequest(string SystemName, IReadOnlyList<SimulationDealRequest> Deals);
...
public record SimulationResponse(string SystemName, int DealCount, int FailedCount, IReadOnlyList<SimulationDealResult> Deals);
